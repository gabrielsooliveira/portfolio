<template>
    <footer class="body-font bg-zinc-50 dark:bg-zinc-900">
        <div class="container p-5 mx-auto flex items-center sm:flex-row flex-col ">
            ...
            <a href="https://github.com/OliveiraGabrielDev" target="_blank" class="text-xl mx-2 text-zinc-600 transition-colors duration-100 transform dark:text-zinc-300 hover:text-indigo-900 dark:hover:text-teal-500" aria-label="Github">
